...
export default class Player {
  constructor(id, name, skinPath, position) {
    ...
    //partie 4
    // Position précédente
    this.precedenteX = this.renderX;
    this.precedenteY = this.renderY;
    this.finalX = this.renderX;
    this.finalY = this.renderY;

    //partie 3
    //--- taille par defaut du joueur
    this.framewidth = 64;
    this.frameheight = 64;
  ...
  interpolate(alpha) {
    console.log("--------------------");
    this.finalX = this.precedenteX + (this.renderX - this.precedenteX) * alpha;
    this.finalY = this.precedenteY + (this.renderY - this.precedenteY) * alpha;
    console.log(this.precedenteX, this.precedenteY);
